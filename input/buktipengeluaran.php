<div class="templatemo-content-wrapper">
	<div class="templatemo-content">
		...
		<div class="row">
			<div class="col-md-12">
				<form role="form" id="templatemo-preferences-form" action="proses/inputSBP.php" method="POST">
					<div class="row">
						<div class="col-md-6 margin-bottom-15">
							<label for="noSBP" class="control-label">Nomor Surat Bukti Pengeluaran</label>
							<input type="text" name="noSBP" class="form-control" id="noSBP" placeholder="Nomor Surat Bukti Pengeluaran" required>
						</div>
					...
					<div class="row">
						<div class="col-md-6 margin-bottom-15">
							...
							<input type="text" name="tahunAnggaran" id="tahunAnggaran" class="form-control" placeholder="Tahun Anggaran" required>
						</div>

						<div class="col-md-6 margin-bottom-15">
							<label for="tanggalInventaris" class="control-label">Tanggal Inventaris</label>
							<input type="text" name="tanggalInventaris" id="tanggalInventaris" class="form-control tanggal readonly" placeholder="Tanggal Inventaris" required>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 margin-bottom-15">
							...
							<input type="text" name="jumlahUang" id="jumlahUang" class="form-control" placeholder="Uang Sejumlah" required>
						</div>

						<div class="col-md-6 margin-bottom-15">
							<label for="untukPembayaran" class="control-label">Untuk Pembayaran</label>
							<input type="text" name="untukPembayaran" id="untukPembayaran" class="form-control" placeholder="Untuk Pembayaran" required>
						</div>
					</div>
					...
					<div class="row" id="optHide">
						...
						<div class="col-md-6 margin-bottom-15" hidden>
							...
							<input type="text" name="jumlahBelanja" id="jumlahBelanja" class="form-control" placeholder="jumlahBelanja" required disabled>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 margin-bottom-15">
							...
							<input type="text" name="penerimaPembayaran" id="penerimaPembayaran" class="form-control" placeholder="Yang Berhak Menerima Pembayaran" required>
						</div>

						<div class="col-md-6 margin-bottom-15">
							<label for="penerimaBarang" class="control-label">Yang Menerima Barang/Memeriksa Pekerjaan</label>
							<input type="text" name="penerimaBarang" id="penerimaBarang" class="form-control" placeholder="Yang Menerima Barang/Memeriksa Pekerjaan" required>
						</div>
					</div>
