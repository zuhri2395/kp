				...
				<form role="form" id="templatemo-preferences-form" action="proses/inputPergub.php" method="POST">
					<div class="row">
						<div class="col-md-12 margin-bottom-15">
							...
							<input type="text" name="noPergub" id="noPergub" class="form-control" placeholder="Nomor Peraturan Gubernur" required>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-12 margin-bottom-15">
							...
							<textarea class="form-control" name="keterangan" id="kegiatan" rows="3" placeholder="Kegiatan"></textarea>
						</div>
					</div>
